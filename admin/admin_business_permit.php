...
$mark = $pdo->prepare("UPDATE notification SET is_read_admin=1 
                       WHERE recipient_type='admin' AND module='business_permit' AND is_read_admin=0");
$mark->execute();
?>
<div class="card p-3">
...
$(function(){
    ...
    $('.approveBtn').on('click', function(){
        ...
        $.post('update_status.php', { 
            ...
            if (response === "OK") {
                showToast('Business permit request approved successfully');
            ...
            showToast('Error approving business permit request', 'danger');
        });
    });
    ...
    $('#confirmDecline').on('click', function(){
        ...
        $.post('update_status.php', { 
            ...
            if (response === "OK") {
                ...
                showToast('Business permit request declined successfully');
            ...
            showToast('Error declining business permit request', 'danger');
        });
    });
});
</script>