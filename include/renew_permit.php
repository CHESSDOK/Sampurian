...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $sql = "INSERT INTO business_permit_renewal (
            ...
            business_registration, cedula, barangay_requirements, business_permit, business_payment, payment_proof,
            user_id, payment_type, gcash_ref_no, created_at
        ) VALUES (
            :permit_id, :kind_of_establishment, :nature_of_business,
            :business_reg, :cedula, :barangay_reqs, :business_Permit, :business_Permit_payment, :payment_proof,
