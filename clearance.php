...
if (!empty($user['birthday'])) {
    ...
    $today = new DateTime();
    $age = $today->diff($dob)->y; // get difference in years
}
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <form action="include/submit_clearance.php" method="POST" enctype="multipart/form-data" class="form-section">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="age" required value="<?= htmlspecialchars($age) ?>">
                </div>
                <div class=" col-md-6">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <label class="form-label">Year Stay in Brgy.</label>
                    <input type="text" class="form-control" name="year_stay" required>
                </div>
                <div class="col-md-6">
